...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.hslider1.setMinimum(-80)
        self.hslider1.setMaximum(80)
        ...
        self.hslider2.setMinimum(-30)
        self.hslider2.setMaximum(30)
        
        self.hslider2.setProperty("value", 0)
        ...
        self.hslider3.setMinimum(0.0)
        self.hslider3.setMaximum(40.0)
        self.hslider3.setProperty("value", 0)
